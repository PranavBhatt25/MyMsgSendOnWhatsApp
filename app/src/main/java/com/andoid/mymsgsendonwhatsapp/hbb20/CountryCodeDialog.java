package com.andoid.mymsgsendonwhatsapp.hbb20;
...
//import com.wpa3.productshopify.R;
//import com.wpa3.productshopify.activity.MainActivity;
//import com.wpa3.productshopify.controller.LoginController;
//import com.wpa3.productshopify.recyclerviewfastscroll.FastScroller;
//import com.wpa3.productshopify.util.PrefHelper;

import com.andoid.mymsgsendonwhatsapp.R;
import com.andoid.mymsgsendonwhatsapp.recyclerviewfastscroll.FastScroller;

import java.lang.reflect.Field;
import java.util.List;

//import static com.wpa3.productshopify.util.Util.setDynamicFonts;
...
class CountryCodeDialog {
    ...
    openCountryCodeDialog(final CountryCodePicker codePicker, final String countryNameCode) {
        ...
        AppCompatEditText editText_search = (AppCompatEditText) dialog.findViewById(R.id.editText_search);
...
//        String mFontText = LoginController.getInstance().getSettings().getApplication_font();
//        setDynamicFonts(((MainActivity) context), context, mFontText, textViewTitle);
//        setDynamicFonts(((MainActivity) context), context, mFontText, editText_search);
//        setDynamicFonts(((MainActivity) context), context, mFontText, textView_noResult);


//        if (PrefHelper.getString(PrefHelper.PREF_BTN_BG_COLOR, null) != null) {
//            ColorStateList colorStateList = ColorStateList.valueOf(Color.parseColor(PrefHelper.getString(PrefHelper.PREF_BTN_BG_COLOR, null)));
//            editText_search.setSupportBackgroundTintList(colorStateList);
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                editText_search.setBackgroundTintList(colorStateList);
//            }
//        }
